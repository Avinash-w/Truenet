...
// import HorrorFogScene from "../components/HorrorFogScene";
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center gap-8">
        <div className="md:w-1/2">
          <img
            src="/abouti.jpeg"
            alt="About"
            className=" h-auto rounded-xl shadow-lg object-cover"
          />
        </div>
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-700 mb-4">
            ...
            solutions for our clients with innovation, commitment, and
            excellence.
          </p>
          <p className="text-gray-700 mb-4">
            Our team specializes in delivering top-notch services, ensuring your
            projects succeed while maintaining a customer-first approach.
          </p>
          <p className="text-gray-700 mb-6">
            We value creativity, transparency, and efficiency. Join us on this
            journey to make a meaningful impact together.
          </p>
          {/* Button */}
