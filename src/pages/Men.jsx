  ...
  return (
    ...
    <FilterSection filters={filters} setFilters={setFilters} />
      ...
      <div className="md:col-span-3">
        <h1 className="text-left text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold italic mb-4 sm:mb-6 md:mb-8 text-gray-800">
  <span className="text-[#776c18] " >Truenet Mens</span> Collections
</h1>
